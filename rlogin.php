...
$query="SELECT*FROM reception_details WHERE email='{$email}' AND password='{$password}'LIMIT 1";
...
$query="UPDATE reception_details SET lastlogin=NOW()";
...
<fieldset>
<legend><H1>Reception Login In</H1></legend>
 <?php
