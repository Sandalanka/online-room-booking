...
if(isset($_POST['submit'])){
    ...
    if(empty($error)){
        ...
        $query="INSERT INTO manger(name,idcard,email,password)VALUES('{$name}','{$id}','{$email}','{$password}')";
        
     $results=mysqli_query($connection,$query);
     if($results){
        header('Location:mangerdetails.php?add_user=true');
    }
    else{
        echo '4444';
    }
...
<form action="manageradd.php"method="POST" class="userform">
<p>
